...
export const ChipPage = (props) => {
  return (
    <CommonPage title="Chip">
      ...
      <Chip primary outline>Primary chip</Chip> <Chip secondary outline>Secondary chip</Chip> <Chip success outline>Success chip</Chip> <Chip info outline>Info chip</Chip> <Chip warning outline>Warning chip</Chip> <Chip error outline>Error chip</Chip>

      <Text xl>Filled rounded chips:</Text>
      <Chip primary filled rounded>Primary chip</Chip> <Chip secondary filled rounded>Secondary chip</Chip> <Chip success filled rounded>Success chip</Chip> <Chip info filled rounded>Info chip</Chip> <Chip warning filled rounded>Warning chip</Chip> <Chip error filled rounded>Error chip</Chip>
      
      <Text xl>Outline rounded chips:</Text>
      <Chip primary outline rounded>Primary chip</Chip> <Chip secondary outline rounded>Secondary chip</Chip> <Chip success outline rounded>Success chip</Chip> <Chip info outline rounded>Info chip</Chip> <Chip warning outline rounded>Warning chip</Chip> <Chip error outline rounded>Error chip</Chip>
    </CommonPage>
  );
};