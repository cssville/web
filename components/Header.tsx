...
export const Header = (props: any) => {
  return (
    <>
    <div className="position-fixed w-12 border-bottom-1 mb-3 h-64px md-h-inherit z-10 bg-color-white">
      <div className="mx-auto max-w-xl px-5 lg-px-3 md-px-2">
        <div className="d-flex flex-direction-row py-2">
    ...
    <div className="w-12 h-64px position-relative mb-3"></div>
    </>
  );
}
